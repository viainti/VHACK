...
`}
      ...
      <div className="hidden md:flex items-center gap-2 mb-6">
        ...
        <h1 className="text-xl font-bold theme-primary glitch glow-primary" data-text="VHACK">
          VHACK
        </h1>
      </div>
      ...
      <div className="md:hidden mb-6 text-center">
        ...
        <h1 className="text-xl font-bold theme-primary mt-2 glitch glow-primary" data-text="VHACK">
          VHACK
        </h1>
      </div>
      ...
      {/* Powered by viainti */}
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 text-xs theme-secondary opacity-50 select-none text-center">
        Powered by <span className="theme-primary font-bold">viainti</span>
      </div>
