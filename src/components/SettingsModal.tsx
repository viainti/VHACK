    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm theme-secondary mb-4">
          Your API key is stored locally and never sent to VHACK servers.
          Get your key at{' '}
          <a
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm theme-secondary">
          VHACK respects your privacy. No data is sent anywhere except to the model providers you choose.
        </p>
      </div>
...
function DataTab() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = `VHACK-backup-${new Date().toISOString().split('T')[0]}.json`
    a.click()
    ...
    reader.onload = (event) => {
      try {
        ...
        if (typeof imported !== 'object' || imported === null) {
          throw new Error('Not a valid VHACK export file.')
        }
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg border border-theme-primary bg-theme-accent/50">
        ...
        <p className="text-sm theme-secondary leading-relaxed">
          VHACK stores everything locally in this browser — conversations, memories, settings, API keys.
