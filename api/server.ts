...
app.get('/v1/info', (_req, res) => {
  res.json({
    name: 'VHACK Research Preview API',
    version: '0.4.0',
    ...
    source: 'https://github.com/LYS10S/VHACK',
  })
})
...
app.get('/v1/models', (_req, res) => {
  ...
  const virtualModels = [
    { id: 'ultraplinian/fast', owned_by: 'VHACK' },
    { id: 'ultraplinian/standard', owned_by: 'VHACK' },
    { id: 'ultraplinian/smart', owned_by: 'VHACK' },
    { id: 'ultraplinian/power', owned_by: 'VHACK' },
    { id: 'ultraplinian/ultra', owned_by: 'VHACK' },
    // CONSORTIUM — hive-mind synthesis from all models
    { id: 'consortium/fast', owned_by: 'VHACK' },
    { id: 'consortium/standard', owned_by: 'VHACK' },
    { id: 'consortium/smart', owned_by: 'VHACK' },
    { id: 'consortium/power', owned_by: 'VHACK' },
    { id: 'consortium/ultra', owned_by: 'VHACK' },
  ]
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`
  ╔══════════════════════════════════════════════════════════╗
  ║  VHACK Research Preview API v0.4.0                     ║
