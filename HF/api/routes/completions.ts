 ...
 *   client = OpenAI(base_url="https://your-VHACK.hf.space/v1", api_key="g0d_xxx")
 ...
 *
 * VHACK-specific options (pass via extra_body in the OpenAI Python SDK):
...
completionsRoutes.post('/completions', async (req, res) => {
  ...
  try {
    const {
      ...
      frequency_penalty,
      presence_penalty,
      // VHACK extras (use extra_body in OpenAI SDK)
